...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	@Override
	//used to authenticate user which is read from login user model
	//if the user details match in authentication then a new method will be triggered
	//its called successful authentication
